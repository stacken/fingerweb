...
class User(AbstractUser):
    payed_year = models.PositiveSmallIntegerField(null=True, blank=True)
    ths_verified_vt = models.PositiveSmallIntegerField(null=True, blank=True)
    ths_verified_ht = models.PositiveSmallIntegerField(null=True, blank=True)
    ths_claimed_vt = models.PositiveSmallIntegerField(null=True, blank=True)
    ths_claimed_ht = models.PositiveSmallIntegerField(null=True, blank=True)
